...
* @Version: 1.0
*
* @Goal: Just about every game these days (okay not every one but a lot of them) allow
* you to take "snapshots" in the game. "World of Warcraft" lets you do this, and it
* provides an easy way to upload new screenshots for interested players to your website.
*/
#include "PeonMain.h"
...
int main( int argc, char* argv[] )
{
	...
	if(!peon::EngineCore::getSingleton().loadEngine("BasicScreenshot", "data\\system.ini"))
	{
		return -1;
	}
...
void MainApp::onRenderWorld()
{
	...
	m_pFont->renderText( 10.0f, 10.0f, "Hit 'F1' to take screenshot" );
...
void MainApp::onKeyEvent(SDL_KeyboardEvent* pEvent )
{
	if(pEvent->type == SDL_KEYDOWN)
	{
		...
		{
			peon::EngineCore::getSingleton().getRenderer()->getScreenCapture();
