...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib sdl.lib sdlmain.lib PeonMain.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\HelloWorld.pdb" /machine:I386 /out:"$(OUTDIR)\HelloWorld.exe" 
LINK32_OBJS= \
	"$(INTDIR)\main.obj"
